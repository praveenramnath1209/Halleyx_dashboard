...
export function CanvasWidget({ widget, isSelected, isDragging, isPushed, onSelect, onDelete, startDrag, startResize, style }) {
  return (
    <div
    ...
    >
      ...
      <div className={styles.dragHandle} onMouseDown={e => startDrag(e, widget)} />
      ...
      {/* Resize grip */}
      <div className={styles.resizeHandle} onMouseDown={e => startResize(e, widget)}>
